...
welcome = media.Movie('Welcome',
                      'A brother who is a underworld don want her sister to marry a well stablised guy.',
                      'http://bharat-movies.com/hindi/img/MovieImg/Welcome-2007-MovieImg.jpg',
                      'https://www.youtube.com/watch?v=QJCMdzuLG0I')

inception = media.Movie('Inception',
                        'A thief with the rare ability to enter people\'s dreams.',
...
harry_potter = media.Movie('Harry Potter and the deathly hallows',
                           'Harry , Ron and Hermione begin a mission to destroy the Horcruxes',
...
dawn_o_t_p_o_apes = media.Movie('Dawn of the Planet of the Apes',
                                'Caesor was offered protection of his people and re-establishion of a relationship with humans.',
...
# Movie list contains all out movie instances and passed to open_movies_page method.
